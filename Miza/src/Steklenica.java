 ...
 * @author Aleksander Porenta
 *
 */
public class Steklenica {
	/**
	 * staticna konstanta lastnost materiala
	 */
        ...
        /**
         * Javni konstruktor
         * @param k k - kapaciteta steklenice
         */
         ...
         * @param v  v - vrsta vsebine
         * @return 	 količina vsebine po polnjenju
         * @throws Exception ki vrže izjemo, če je steklenica zaprta
         */
